...
from common import N_GPUS, GPU_MEM, BASE_MODELS, VOLUME_CONFIG
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Llama on local. USAGE : `python train_offline.py --dataset datasubjects_dataset.py --base code7 --run-id code7-data-subjects`')

    # Required positional argument
    parser.add_argument('--dataset', type=str,
                        help='Path to dataset loader file in datasets directory')
    ...
    print(args.base)
    print(args.run_id)
    main(args.dataset, args.base, args.run_id)
